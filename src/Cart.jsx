            ...
            <div className="subject">
                ...
                <div>
                   ...
                   <div className="addRemoveButtons">
                    ...
                    <button className="addButton" onClick={()=>dispatch(cartIncrement())}>Add to cart</button>
                      {/* cartDecrement is dispatched while onClick operationg remove item is performed */}
                    <button className="removeButton" onClick={()=>dispatch(cartDecrement())}>Remove from cart</button>
                   </div>
